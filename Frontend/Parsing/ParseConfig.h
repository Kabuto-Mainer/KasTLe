...
constexpr KTL_ParseTokenRef KTL_PARSE_CAST_LEFT  = KTL_PARSE_PUNCT(KTL_PUNCT_LEFT_TRIG);
constexpr KTL_ParseTokenRef KTL_PARSE_CAST_RIGHT = KTL_PARSE_PUNCT(KTL_PUNCT_RIGHT_TRIG);
